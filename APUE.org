...
** I/O Efficiency
   ...
   #+include: "Chapter03/mycat.c" src c
** File Sharing
...
** Formated I/O
   ...
   |---------+---------------------------------------------------------------------------------------|
   | /       | <>                                                                                    |
   | '       | #+caption: (apostrophe) format integer with thousands grouping characters
   #+include: "Chapter05/formatted.c" src c                        |
   | -       | #+caption: left justify
   #+include: "Chapter05/formatted.c" src c                                                                          |
   | +       | #+caption: always display sign of a signed conversion
   #+include: "Chapter05/formatted.c" src c                                            |
   | (space) | #+caption: prefix by a space if no sign is generated
   #+include: "Chapter05/formatted.c" src c                                             |
   | \#      | #+caption: convert using alternative form(include 0x prefix for hexadecimal format, for example)
   #+include: "Chapter05/formatted.c" src c |
   | 0       | #+caption: prefix with leading zeros instead of padding with spaces
   #+include: "Chapter05/formatted.c" src c                              |
   ...
   |-----------------+-------------------------------------------------------------------------------------------|
   | /               | <>                                                                                        |
   | d,i             | #+caption: signed decimal
   #+include: "Chapter05/formatted.c" src c                                                                            |
   | o               | #+caption: unsigned octal
   #+include: "Chapter05/formatted.c" src c                                                                            |
   | u               | #+caption: unsigned decimal
   #+include: "Chapter05/formatted.c" src c                                                                          |
   | x,X             | #+caption: unsigned hexadecimal
   #+include: "Chapter05/formatted.c" src c                                                                      |
   | f,F             | #+caption: double floating-point number
   #+include: "Chapter05/formatted.c" src c                                                              |
   | e,E             | #+caption: double floating-point number in exponential format
   #+include: "Chapter05/formatted.c" src c                                        |
   | g,G             | #+caption: interpreted as f, F, e, or E, depending on value converted
   #+include: "Chapter05/formatted.c" src c                                |
   | a,A             | #+caption: double ﬂoating-point number in hexadecimal exponential format
   #+include: "Chapter05/formatted.c" src c                             |
...
** 8.13 ~system~ Function
   ...
   *if /cmdstring/ is a ~NULL~, ~system~ returns nonzero only if a command processor is available.
   ...
   - Example \\
     ...
     #+include: "Chapter08/system.c" src c
...
** 11.4 Thread Creation
   ...
   - Example \\
     ...
     #+include: "Chapter11/threadid.c" src c
** 11.5 Thread Termination
   ...
   - Example \\
     ...
     #+include: "Chapter11/exitstatus.c" src c

...
** Input and Output
   ...
   - Unbuffered I/O
     - Example \\
       [[file:Chapter01/mycp.c::#include%20"apue.h"][Figure 1.4 Copy standard input to standard output]]

   - Standard I/O
     - Example \\
       [[file:Chapter01/getcputc.c::#include%20"apue.h"][Figure 1.5 Copy standard input to standard output, using standard I/O]]
** Programs and Processes
   - Program
   - Proceses and Process ID
     - Example \\
       [[file:Chapter01/uidgid.c::#include%20"apue.h"][Figure 1.6 Print the process ID]]
   - Process Control
     - Example \\
       [[file:Chapter01/shell1. c::#include%20"apue.h"][Figure 1.7 Read commands from standard input and execute them]]
** Error Handling
   - Example \\
     [[file:Chapter01/testerror.c::#include%20"apue.h"][Figure 1.8 Demonstrate strerror and perror]]
** User identification
   - User ID
   - Group ID
     - Example \\
       [[file:Chapter01/uidgid.c::#include%20"apue.h"][Figure 1.9 Print user ID and group ID]]
...
** Signals
   ...
   - Example \\
     [[file:Chapter01/shell2. c::#include%20"apue.h"][Figure 1.10 Read commands from standard input and execute them]]
** Time Values
   1.  Calendar time.
   2.  Process time.
      - Clock time
...
*** =sysconf=, =pathconf=, and =fpathconf= Functions
    [[file:Chapter02/makeconf.awk::#!/usr/bin/awk%20-f][Figure 2.13 Build C program to print all supported configuration limits]]
*** Indeterminate Runtime Limits
    1.  [[file:lib/pathalloc.c::#include%20"apue.h"][pathalloc]]
    2.  [[file:lib/openmax.c::#include%20"apue.h"][openmax]]
** Options
...
** Summary
   *Exercises*
   ...
   3.  [[file:Chapter02/ex02.c::#include%20"apue.h"][OPEN_MAX exercise]]
* Chapter 3. File I/O
  :PROPERTIES:
...
** =lseek= Function
   =man 2 lseek=
   - Example \\
     [[file:Chapter03/seek.c::#include%20"apue.h"][Figure 3.1 Test whether standard input is capable of seeking]] \\
     [[file:Chapter03/hole.c::#include%20"apue.h"][Figure 3.2 Create a file with a hole in it]]
** =read= Function
   =man 2 read=
** =write= Function
   =man 2 write=
** I/O Efficiency
   [[file:Chapter03/mycat.c::#include%20"apue.h"][Figure 3.5 Copy standard input to standard output]]
** File Sharing
...
** =fcntl= Function
   ...
   - Example \\
     [[file:Chapter03/fileflags.c::#include%20<fcntl.h>][Figure 3.11 Print file flags for specified descriptor]] \\
     [[file:Chapter03/setfl.c::#include%20<fcntl.h>][Figure 3.12 Turn on one or more of the file status flags for a descriptor]]
** =ioctl= Function
   =man 2 ioctl=
** =/dev/fd=
** Summary
   *Exercises*
   ...
   2.  [[file:Chapter03/mydup2.c::#include%20"apue.h"][mydup2]]
   ...
   6.  [[file:Chapter03/ex06.c::#include%20<fcntl.h>][ex06]], can be read random, but cannot replace existing data;
* Chapter 4. System Data Files and Information
** 4.1 Introduction
...
** 4.3 File Types
   ...
   - Example \\
     [[file:Chapter04/filetype.c::#include%20"apue.h"][Figure 4.3 Print type of file for each command-line argument]]
...
** =access= and =faccessat= Functions
   =man 2 access=
   - Example \\
     [[file:Chapter04/access.c::#include%20<fcntl.h>][Figure 4.8 Example of access function]]
** =umask= Function
   =man 2 umask=
   - Example \\
     [[file:Chapter04/umask.c::#include%20"apue.h"][Figure 4.9 Example of umask function]]
** =chmod=, =fchmod=, and =fchmodat= Functions
   =man 2 chmod=
   - Example \\
     [[file:Chapter04/changemod.c::#include%20"apue.h"][Figure 4.12 Example of chmod function]]
** Sticky Bit
...
** =link=, =linkat=, =unlink=, =unlinkat=, and =remove= Functions
   =man 2 link=
   - Example \\
     [[file:Chapter04/unlink.c::printf("file%20unlinked\n");][Figure 4.16 Open a file and then unlink it]]
...
** =futimens=, =utimensat=, and =utimes= Functions
   ...
   =man 2 utimes=
   - Example \\
     [[file:Chapter04/futimens.c::#include%20<fcntl.h>][Figure 4.21 Example of futimens function]]
...
** =chidr=, =fchdir= and =getcwd= Functions
   =man 2 chdir=
   - Example \\
     [[file:Chapter04/chdir.c::#include%20"apue.h"][Figure 4.23 Example of chdir function]]
   =man 3 getcwd=
   - Example \\
     [[file:Chapter04/getcwd.c::#include%20"apue.h"][Figure 4.24 Example of getcwd function]]
** Device Special Files
   - Example \\
     [[file:Chapter04/devrdev.c::#include%20"apue.h"][Figure 4.25 Print st_dev and st_rdev values]]
...
** Summary
   *Exercises*
   1.  [[file:Chapter04/exercises/ex1.c::#include%20"apue.h"][ex01]]
   ...
   6.  [[file:Chapter04/exercises/ex6.c::#include%20<fcntl.h>][ex06]]
   ...
   11.  [[file:Chapter04/exercises/ex11.c::#include%20<dirent.h>][ex11]]
   12.  FTP
   ...
   16.  [[file:Chapter04/exercises/ex16.c::#include%20<fcntl.h>][ex16]] \\
   17.  [[file:Chapter04/exercises/ex17.c::#include%20<fcntl.h>][ex17]] \\
...
** Standard I/O Efficiency
   [[file:Chapter05/cpio.c::#include%20"apue.h"][Figure 5.4 Copy standard input to output using getc and putc]] \\
   [[file:Chapter05/cpio_1. c::#include%20"apue.h"][Figure 5.5 Copy standard input to output using fgets and fputs]]
** Binary I/O
   =man fread=
...
** Implementation Details
   ...
   - Example \\
     [[file:Chapter05/print.c::#include%20"apue.h"][Figure 5.11 Print buffering for various standard I/O streams]]
** Temporary Files
   =man 3 tmpnam=
   - Example \\
     [[file:Chapter05/tmpnam.c::#include%20"apue.h"][Figure 5.12 Demonstrate tmpnam and tmpfile functions]]


   =man 3 mkdtemp=
   - Example \\
     [[file:Chapter05/mkdtemp.c::#include%20"apue.h"][Figure 5.13 Demonstrate mkstemp function]]
** Memory Streams
   =man 3 fmemopen=
   - Example \\
     [[file:Chapter05/memopen.c::#include%20"apue.h"][Figure 5.15 Investigate memory stream write behavior]] \\
     *linux* result:
     #+begin_quote
...
** Summary
   *Exercises*
   1.  [[file:Chapter05/exercises/ex1.c::#include%20"apue.h"][ex01]]
   2.  [[file:Chapter05/exercises/ex2.c::#include%20"apue.h"][ex02]] \\
   ...
   7.  [[file:Chapter05/exercises/funopen-fmemopen.c::#include%20<errno.h>][ex07]]
...
** Supplementary Group Ids
   =man getgroups= \\
   - Example \\
     [[File:Chapter06/getgropus.c::#include%20<stdio.h>][Example for get groups' info]]
...
** Time and Date Routines
   ...
   =man 3 strftime=
   - Example \\
     [[file:Chapter06/strftime.c::#include%20<stdio.h>][Figure 6.11 Using the strftime function]] \\
   =man 3 strptim=
** Summary
   *Exercises*
   1.  On Mac OS, I can't get it \\
      On Linux, use =getsnam= group functions
   2.  [[file:Chapter06/exercises/getspnam.c::#include%20<shadow.h>][ex2]]
   3.  [[file:Chapter06/exercises/uname.c::#include%20<stdio.h>][ex3]], equivalent
   4.  32-bit time: =1970 + (2^{31}/60/60/24/365)= \\
      after pass : =1970 - (2^{31}/60/60/24/365)=
   5.  [[file:Chapter06/exercises/time.c::#include%20<time.h>][ex5]]
...
*** Exit Functions
    ...
    - Example \\
      ...
      #+end_src
      [[file:Chapter07/hello.c::#include%20<stdio.h>][Figure 7.1 Classic C program]]
*** ~atexit~ Function
    =man 3 atexit=
    The ~exit~ function calls these functions in reverse order of their registration.

    - Example \\
      [[file:Chapter07/atexit.c::#include%20"apue.h"][Figure 7.3 Example of exit handlers]]
*** Commond-Line Arguments
    - Example \\
      [[file:Chapter07/echoarg.c::#include%20"apue.h"][Figure 7.4 Echo all command-line arguments to standard output]]
...
** 7.10 =setjmp= and =longjmp= Functions
   ...
   - Example \\
     [[file:Chapter07/cmd_add.c::#include%20"apue.h"][Figure 7.9 Typical program skeleton for command-processing]] \\


   =man 3 setjmp=
   - Example \\
     [[file:Chapter07/testjmp.c::#include%20<setjmp.h>][Figure 7.13 Effect of longjmp on various type of variables]]
   ...
   *Potential Problem with Automatic Variables*
   [[file:Chapter07/incorrect_usage.c::#include%20<stdio.h>][Figure 7.14 Incorrect usage of an automatic variable]]
   #+begin_quote
...
** =getrlimit= and =setrlimit= Functions
   =man 3 getrlimit=
   - Example \\
     [[file:Chapter07/rlimit.c::#include%20<sys/resource.h>][Figure 7.16 print the current resource limits]]
** Summary
   *Exercises*
...
** 8.3 =fork= Function
   ...
   - Example \\
     [[file:Chapter08/fork.c::#include%20"apue.h"][Figure 8.1 Example of fork function]] \\
...
** 8.4 ~vfork~ Function
   ...
   *vfork guarantees that the child runs first, until the child calls exec or exit.*
   #+end_quote
   - Example \\
     [[file:Chapter08/vfork.c::#include%20"apue.h"][Figure 8.3 Example of vfork function]]
** 8.5 =exit= Function
   #+begin_quote
...
** 8.6 =wait= and =waitpid= Functions
   ...
   - Example \\
     [[file:Chapter08/exit_status.c::#include%20<sys/wait.h>][Figure 8.5 Print a description of the exit status]] \\
     [[file:Chapter08/exit.c::#include%20"apue.h"][Figure 8.6 Demonstrate various exit status]]
   ...
   - Example \\
     [[file:Chapter08/waitpid.c::#include%20"apue.h"][Figure 8.8 Avoid zombie processes by calling fork twice]]
** 8.7 =waitid= Function
   =man 2 waitid=
   #+begin_src c
...
** 8.9 Race Conditions
   *Avoid race by signal*
   - Example \\
     [[file:Chapter08/race.c::#include%20"apue.h"][Figure 8.12 Program with a race condition]] \\
     [[file:Chapter08/avoid_race.c::#include%20"apue.h"][Figure 8.13 Modification of Figure 8.12 to avoid race condition]]
** 8.10 =exec= Functions
   =man 3 exec=
   #+begin_src c
     #include <unistd.h>
   ...
   - Example \\
     [[file:Chapter08/exec.c::#include%20<sys/wait.h>][Figure 8.16 Example of exec functions]] \\
     [[file:Chapter08/echo_env.c::#include%20"apue.h"][Figure 8.17 Echo all command-line arguments and all environment strings]]
...
** 8.12 Interpreter Files
   - Example \\
     [[file:Chapter08/exec_intr.c::#include%20<sys/wait.h>][Figure 8.20 A program that execs an interpreter file]] \\
     [[file:Chapter08/awkexample::#!/usr/bin/awk%20-f][Figure 8.21 An awk program as an interpreter file]]
** 8.13 =system= Function
   ...
   *if /cmdstring/ is a ~NULL~, ~system~ returns nonzero only if a command processor is available.
   ...
   3. Otherwise, all three functions—fork, exec, and waitpid—succeed, and the return value from system is the termination status of the shell, in the format speciﬁed for waitpid.
   #+end_quote
   - Example \\
     [[file:Chapter08/system.c::#include%20<sys/wait.h>][Figure 8.22 The system function, without signal handling]]
     [[file:Chapter08/system.c::int][Figure 8.23 Calling the system function]]
   ...
   *Set-User-ID Programs*
   [[file:Chapter08/systest.c::#include%20"apue.h"][Figure 8.24 Execute the command-line argument using system]]


   [[file:Chapter08/pruids.c][Figure 8.25 Print real and effective user IDs]]
** 8.14 Process Accounting
   - Example \\
     [[file:Chapter08/acct_data.c::#include%20"apue.h"][Figure 8.28 Program to generate accounting data]] \\
     [[file:Chapter08/print_sel_acct.c::#include%20<sys/acct.h>][Figure 8.29 Print select fields from system's accounting file]]
** 8.15 User Identification
   =man 2 getlogin=
   [[file:Chapter08/getlogin.c::#include%20"apue.h"][getlogin]]
** 8.16 Process Scheduling
   ...
   =man 3 getpriority=
   - Example \\
     [[file:Chapter08/nice.c::#include%20<errno.h>][Figure 8.30 Evaluate the effect of changing the nice value]]
** 8.17 Process Times
   #+begin_src c
     #include <sys/times.h>
...
** 8.18 Summary
   ...
   - Exercises
     - [[file:Chapter08/ex8.1.c::#include%20"apue.h"][8.1]]
     - [[file:Chapter08/ex8.2.c::#include%20"apue.h"][8.2]]
     - [[file:Chapter08/ex8.1.c::#include%20"apue.h"][8.3]]
     - 8.4
In Figure 8.13, we have the parent write its output ﬁrst. When the parent is done, the child writes its output, but we let the parent terminate. Whether the parent terminates or whether the child ﬁnishes its output ﬁrst depends on the kernel’s scheduling of the two processes (another race condition). When the parent terminates, the shell starts up the next program, and this next program can interfere with the output from the previous child.
We can prevent this from happening by not letting the parent terminate until the child has also ﬁnished its output. Replace the code following the fork with the following:
#+begin_src c
   else if (pid == 0) {
...
#+end_src
We won’t see this happen if we let the child go ﬁrst, since the shell doesn’t start the next program until the parent terminates.
    - 8.5 The same value
    - [[file:Chapter08/ex8.6.c::#include%20"apue.h"][8.6]]
...
** 10.19 =sleep=, =nanaosleep=, and =clock_nanosleep= Functions
...
** 11.4 Thread Creation
   =man pthread_create=
   - Example \\
     [[file:Chapter11/threadid.c::#include%20"apue.h"][Figure 11.2 Printing thread IDs]]
** 11.5 Thread Termination
   ...
   #+end_src
   - Example \\
     [[file:Chapter11/exitstatus.c::#include%20"apue.h"][Figure 11.3 Fetching the thread exit status]]
...
** 14.2 Nonblocking I/O
   ...
   * IPC
   ...
   - Example \\
     [[file:Chapter14/write.c::#include%20<errno.h>][Figure 14.1 Large nonblocking write]]
** 14.3 Recording Locking
...
*** 2. =fcntl= Record Locking
    ...
    - Example - Deadlock \\
      [[file:Chapter14/deadlock.c::#include%20"apue.h"][Figure 14.7 Example of deadlock detection]]

    - Advisory versus Mandatory Locking
      - Example \\
        [[file:Chapter14/mandatory.c::#include%20"apue.h"][Figure 14.12 Determine whether mandatory locking is supported]]
...
** 14.8 Memory-Mapped I/O
   - Example
     [[/Users/zhoush/Documents/Private/Notes/books/c/APUE/Chapter14/mcopy2.c][Figure 14.27 Copy a file using memory-mapped I/O]]
** 14.9 Summary
...
** 17.2 UNIX Domain Sockets
   - Example -- Polling XSI Message Queues with the Help of UNIX Domain Sockets
     ...
     [[file:Chapter17/pollmsg.c::#include%20"apue.h"][Figure 17.3 Poll for XSI Messsages using UNIX domain sockets]]

     [[file:Chapter17/sendmsg.c::#include%20"apue.h"][Figure 17.4 Post a message to XSI message queue]]
*** 17.2.1 Naming UNIX Domain Sockets
    - Example \\
      [[file:Chapter17/bindunix.c::#include%20<apue.h>][Figure 17.5 Binding an address to a UNIX domain socket]]
** 17.3 Unique Connections
   ...
   #+end_center
   [[file:Chapter17/cli_conn.c::#include%20"apue.h"][Figure 17.10 The =cli_conn= function]]
...
* Chapter 21. Communication with a Network Printer

...
* Advanced Programming in the Unix Environment [66%]
...
*** DONE 14.2 Nonblocking I/O
    ...
    * IPC
    ...
    - Example \\
      ...
      #+include: "Chapter14/fig14.1.c" src c
      #+begin_src sh :result
        ls -l /etc/services
        bin/fig14.1 < /etc/services > temp.file
        ls -l temp.file
      #+end_src
      ...
      #+begin_src sh :result
        bin/fig14.1 < /etc/services 2>stderr.out
        cat stderr.out
      #+end_src
...
*** 14.4 I/O Multiplexing [2/2]
    ...
    #+begin_src dot :file Chapter14/fig14.13.png :cmdline -Kdot -Tpng
      digraph G {
    ...
    #+RESULTS:
    [[file:Chapter14/fig14.13.png]]

    #+begin_src dot :file Chapter14/fig14.14.png :cmdline -Kdot -Tpng
      digraph G {
...
*** DONE 14.7 ~readn~ and ~writen~ Functions
    ...
    #+include: "Chapter14/fig14.24.c" src c
*** DONE 14.8 Memory-Mapped I/O
    ...
    [[file:Chapter14/fig14.26.png]]

    /flag/ argument:
    - MAP_FIXED: The return value must euqal /addr/.
    ...
    - Example
      ...
      #+include: "Chapter14/fig14.27.c" src c
    ...
    [[file:Chapter14/fig14.28.png]]
*** DONE 14.9 Summary
    CLOSED: [2019-12-29 Sun 02:15]
   - Exercises
     - 14.1
       #+include: "Chapter14/ex14.1.c" src c
     - 14.2
       #+begin_quote
     ...
     - 14.7
       ...
       #+end_quote
     - 14.8
       #+include: "Chapter14/ex14.8.c" src c
     - 14.9
       just try to execute the program with a very large file
     - 14.10
       Not changed
     - 14.11
       #+include: "Chapter14/ex14.11.c" src c

...
** TODO Chapter 13. Daemon Processes [2/8]
...
*** DONE 13.2 Daemon Characteristics
    ...
    * The jbd daemon helps implement the journal in the ext4 file system.
    ...
    #+end_quote
*** TODO 13.3 Coding Rules
*** TODO 13.4 Error Logging
*** TODO 13.5 Single-Instance Daemons
*** TODO 13.6 Daemon Conventions
*** TODO 13.7 Client-Server Model
*** TODO 13.8 Summary
